...
public class EmployeeDocumentController {
	...
	public ResponseEntity<String> getEmployeeDocument(@PathVariable String employeeId,@RequestParam("emailMe") String emailId
    ...
    public ResponseEntity<String> sendMail(@RequestBody EmailDetail emailDetail)
    {
        employeeDocumentService.sendNotification(emailDetail);
