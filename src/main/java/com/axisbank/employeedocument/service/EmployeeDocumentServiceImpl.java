...
public class EmployeeDocumentServiceImpl implements EmployeeDocumentService {
	...
	@Override
	public EmployeeDocument getEmployeeDocument(String employeeId, String emailId,String documentName) throws MessagingException {
	...
	@Override
	public void sendNotification(EmailDetail emailDetail) {
		try {
			SimpleMailMessage sendNotification=new SimpleMailMessage();
			sendNotification.setFrom(sender);
			sendNotification.setTo(emailDetail.getEmailId());
			sendNotification.setText(emailDetail.getMessageBody());
			sendNotification.setSubject(emailDetail.getMessageSubject());
